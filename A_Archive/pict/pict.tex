...
%            \draw[-latex] (O) -- node[pos=0.5, below] {$\vec{R}_O$} +(25:10) coordinate (end) ;
...
\begin{frame}{}{}
    ...
    E(\vec{\mathcal{F}}) = E(0) +
    \hl[remember as=d1]{\left(\frac{d E}{d \vec{\mathcal{F}}}\right)_{\vec{\mathcal{F}}=0}}\vec{\mathcal{F}} +
    \frac{1}{2!}\hl[remember as=d2]{\left(\frac{d^2 E}{d \vec{\mathcal{F}}^2}\right)_{\vec{\mathcal{F}}=0}}\vec{\mathcal{F}}^2 +
    \frac{1}{3!}\hl[remember as=d3]{\left(\frac{d^3 E}{d \vec{\mathcal{F}}^3}\right)_{\vec{\mathcal{F}}=0}}\vec{\mathcal{F}}^3 +
    \ldots
\end{equation*}
