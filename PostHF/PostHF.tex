...
% ============================== Слайд ## ===================================
\begin{frame}{Кореляція в атомі \ce{He}}{}
...
% ============================== Слайд ## ===================================
\begin{frame}{Збуджені стани}{}
	\begin{block}{}
		Збуджені електронні стани атома/молекули --- розв'язки (\alert{\texttt{roots}}) рівняння Шредінгера для функцій $m > 0$:
		\begin{equation*}
			\tcbhighmath{\hat{H}_e(\vec{R})\Phi_{\color{red}n}(\vxi\,|\,\vec{R}) = E_{e_{\color{red}n}}(\vec{R})\Phi_{\color{red}n}(\vxi\,|\,\vec{R})}
		\end{equation*}
	\end{block}
\end{frame}
% ===========================================================================
...
\begin{frame}[fragile]{Метод конфігураційної взаємодії}{}
	...
	\begin{onlyenv}<5-6>
		...
		\begin{overprint}\footnotesize
			...
			% -----------------------------------------------------------------
			\begin{itemize}
				\item Матричні елементи  між основним і одноразово збудженими електронними конфігураціями дорівнюють нулю $\bracket<\Phi_0|\hat{H}|\Phi_1> = 0$ (\textcolor{blue}{теорема Бріллюена}).
...
\begin{equation*}
    E = E_A + E_B.
\end{equation*}
В обмеженому методі конфігураційної взаємодії (CISD, CISDT та ін.) елементарна вимога розмірної екстенсивності не
...
\begin{onlyenv}<1>
\begin{block}{}\justifying
    Метод зв'язаних кластерів (Coupled Clusters, СС) можна розглядати як різновид
    методу конфігураційної взаємодії.

    \medskip
    У методі CC багатоелектронну систему
...
\begin{onlyenv}<2>
       \begin{block}{}\justifying
        ...
        \end{block}
        \begin{alertblock}{}
            Важливою перевагою методу зв’язаних кластерів, зокрема методу CCSD, є те, що він задовольняє вимозі розмірної екстенсивності.
        \end{alertblock}
\end{onlyenv}
\end{frame}
% ===========================================================================
