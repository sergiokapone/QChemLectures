...
Концепція відгуку надзвичайно універсальна: практично всі молекулярні властивості можна розглядати як похідні енергії за зовнішніми параметрами --- електричним або магнітним полем, координатами ядер (саме цей випадок був детально розглянутий в розділі \ref{Oscilations}) тощо.
...
Для двох параметрів $x$ і $y$ змішана похідна наближено виражається як
\begin{equation}
...
\end{equation}
У варіаційних методах (\texttt{HF}, \texttt{DFT}, \texttt{CASSCF}) ця умова виконується.
...
У методі Хартрі--Фока енергія залежить від координат ядер двома способами:
...
У наступному розділі ми використаємо ідеї аналітичних похідних,
щоб отримати власні частоти і форми нормальних мод.
