...
# eri_ao — двоелектронні інтеграли в базисі АО (хімік-нотація)
...
# g_ov — права частина CPHF: g^{(μ)}_{ia} = + μ^{(μ)}_{ia}
# Знак "+" — конвенція PySCF: H · U = g
# dip_mo[:, :nocc, nocc:] — блок μ_{ia} (occ → vir)
...
# Крок 1: 4 Σ_{ia} μ^x_ia U^y_ia → einsum
# Результат: (3, 3)
