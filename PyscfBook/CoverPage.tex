...
%			\vspace*{1em}%
		...
		\begin{flushleft}
			\begin{tabular}{lp{0.9\textwidth}}
				...
				С.~М. Пономаренко%,
				--- К.:~КПІ ім. Ігоря Сікорського, 2025. --~\lastpageref{LastPages}~с.
			\end{tabular}
		\end{flushleft}
		\vfill
...
%		\end{flushleft}
	...
	\begin{minipage}[t]{0.55\linewidth}\small
        \textcopyright{} С.~М. Пономаренко, 2025\,р. \\
        \textcopyright{}  КПІ ім. Ігоря Сікорського (ФТІ), 2025~р.
    \end{minipage}
		\newpage%
	\end{alwayssingle}
}
