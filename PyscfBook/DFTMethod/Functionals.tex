...
Однак форма цього потенціалу, а отже і точність усього методу, повністю визначаються вибором функціоналу $E_{xc}[\rho]$.
Оскільки точний вигляд $E_{xc}$ невідомий, у практичних розрахунках використовують різні наближення, які відрізняються складністю та рівнем урахування фізичних ефектів.

Саме за характером залежності $E_{xc}$ від густини та її похідних функціонали теорії функціонала густини поділяються за так званою \textbf{«драбиною Якова»} (Jacob’s ladder), яку запропонував Джон Пердью.
Ця «драбина» символізує послідовні сходинки наближення до священного грааля --- точного функціоналу:
...
\begin{enumerate}
    ...
    \item \textbf{Double-hybrid} --- включають як обмін \texttt{HF}, так і кореляцію \texttt{MP2}.
\end{enumerate}
