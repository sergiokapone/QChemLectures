# ========================================================
#  spherical_electron_density.py
# ========================================================
#  Сферично усереднена електронна густина атома
#  Розрахунок у межах методу Хартрі–Фока (RHF/UHF)
#  Використовується бібліотека PySCF та базис cc-pVDZ
#  Обчислюються:
#    • електронна густина ρ(r)
#    • радіальна функція розподілу 4πr²ρ(r)
#  Результати виводяться у вигляді графіків і перевіряється
#  нормування ∫4πr²ρ(r)dr = Nₑ
