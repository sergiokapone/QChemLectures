# ========================================================
#  Compare_UHF_ROHF_Period2.py
# ========================================================
#  Порівняння енергій і спінових властивостей атомів
#  другого періоду для відкритих оболонок
#  у методах UHF та ROHF.
#
#  Програма виконує:
#    • розрахунок енергій UHF і ROHF
#    • обчислення ⟨S²⟩ і порівняння з очікуваним значенням
#    • оцінку ступеня спінового забруднення
#    • якісну класифікацію результатів
#
#  Базис: 6-31G*
#  Бібліотека: PySCF
# ========================================================
