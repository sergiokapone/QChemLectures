# ==============================================================
#  Koopmans_Theorem_Test.py
# ==============================================================
#  Перевірка теореми Купманса для атомів другого періоду.
#
#  Програма виконує:
#    • Розрахунок енергії іонізації ΔSCF = E(катіон) – E(нейтральний)
#    • Обчислення -ε_HOMO (приблизна IE за теоремою Купманса)
#    • Порівняння обох значень з експериментальними IE
#    • Аналіз відхилень і побудову стовпчикової діаграми
#
#  Методи: RHF / UHF (автоматично за спіном)
#  Базис: cc-pVTZ
#  Бібліотека: PySCF
#  Автор: д-р Конрад Карлович Міхельсон
# ==============================================================
