# ============================================================
# Файл: second_period_hf.py
# Автор: доктор Фейнман
# Опис: Розрахунок енергій атомів другого періоду (Li–Ne)
#       методом Гартрі–Фока (RHF/UHF) у базисі cc-pVDZ.
#       Для відкритих оболонок перевіряється значення <S²>.
#       Результати виводяться в таблиці та зберігаються у файл.
# ============================================================
