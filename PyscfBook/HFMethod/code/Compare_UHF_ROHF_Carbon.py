# ========================================================
#  Compare_UHF_ROHF_Carbon.py
# ========================================================
#  Порівняння обмеженого (ROHF) та необмеженого (UHF)
#  методів Гартрі–Фока для атома Вуглецю (³P)
#
#  Програма виконує:
#    • розрахунок енергії в межах UHF та ROHF
#    • аналіз спінового забруднення (<S²>)
#    • порівняння енергій (ΔE у mHa і kcal/mol)
#    • вивід орбітальних енергій для перших кількох орбіталей
#
#  Бібліотеки: PySCF
#  Базис: cc-pVTZ
# ========================================================
