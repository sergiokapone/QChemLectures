# ============================================================
# Файл: orbital_diagram_pyscf.py
# Автор: доктор Фейнман
# Опис: Побудова діаграм орбітальних енергій для атомів
#       у рамках методів RHF/UHF з використанням PySCF.
#       Результати зберігаються у вигляді PDF-графіків.
# ============================================================
