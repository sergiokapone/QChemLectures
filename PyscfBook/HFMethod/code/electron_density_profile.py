# ========================================================
#  electron_density_profile.py
# ========================================================
#  Розрахунок та візуалізація електронної густини атома
#  Метод Хартрі–Фока (RHF/UHF) з базисом cc-pVDZ
#  Використовується PySCF: побудова профілю густини вздовж осі z
#  Результати зберігаються у форматах PDF та CSV
# ========================================================
