...
# та різних базисних наборів (STO-3G, 3-21G, 6-31G тощо). Обчислюється енергія в Гартрі,
# похибка в міліГартрі порівняно з теоретичним значенням (-0.5 Ha), та будується графік
