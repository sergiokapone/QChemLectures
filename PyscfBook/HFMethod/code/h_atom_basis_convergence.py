# ==============================================================================
# h_atom_basis_convergence.py
# Скрипт виконує UHF-розрахунки для атома гідрогену з використанням бібліотеки PySCF
# та різних базисних наборів (STO-3G, 3-21G, 6-31G тощо). Обчислюється енергія в Хартрі,
# похибка в міліХартрі порівняно з теоретичним значенням (-0.5 Ha), та будується графік
# збіжності енергії залежно від кількості базисних функцій.
# =====================
...
for basis in basis_sets:
    try:
        ...
        n = mol.nao_nr()
        error = (e + 0.5) * 1000  # похибка в міліХартрі
