...
pip install pyscf-properties
    ...
    Цей модуль включає:
    \begin{itemize}
        \item \inlinecode{pyscf.prop.nmr} --- ЯМР константи екранування
        \item \inlinecode{pyscf.prop.esr} --- ЕПР g-тензор, константи надтонкої взаємодії
        \item \inlinecode{pyscf.prop.polarizability} --- поляризовність, гіперполяризовності
        \item \inlinecode{pyscf.prop.magnetizability} --- магнітна сприйнятливість
    \end{itemize}

    \item \texttt{pyscf-geomopt} --- для оптимізації геометрії:
    \begin{minted}{bash}
pip install pyscf-geomopt
    \end{minted}

    \item \texttt{geometric} --- покращена оптимізація (рекомендується):
    \begin{minted}{bash}
...
\begin{enumerate}
    \item \textbf{Коливальні властивості (Секція~\ref{sec:oscillations}):}
    \begin{itemize}
        \item Гессіан та нормальні моди
        \item ІЧ спектри (інтенсивності, правила відбору)
        \item Раман спектри
        \item Термохімія та ZPE
    \end{itemize}

    \item \textbf{Електронні властивості (Секція~\ref{sec:electronic}):}
    \begin{itemize}
    ...
    \item \textbf{Електричні властивості (Секція~\ref{sec:elprop}):}
    \begin{itemize}
    ...
    \item \textbf{Магнітні властивості (Секція~\ref{sec:magprop}):}
    \begin{itemize}
...
\input{\currfiledir/ElectronicSpectra.tex}
