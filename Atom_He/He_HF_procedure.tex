...
\NewDocumentCommand{\J}{e_ m e_ d()}{
...
\NewDocumentCommand{\K}{e_ m e_ d()}{
\ifthenelse{\equal{#2}{\phi}}{\edef\V{V}}{\edef\V{\mathcal{V}}}
% #1 - operator index
% #2 - function name
% #3 - function index
...
\begin{align*}
    \hat{h}(1)\phi(1) +
    \int \frac{\phi^*(2)\phi(2)}{r_{12}} dV_2\ \phi(1)
     = \varepsilon_1\phi(1), \\
    \hat{h}(2)\phi(2) +
    \int \frac{\phi^*(1)\phi(1)}{r_{12}} dV_1\ \phi(2)
     = \varepsilon_2\phi(2).
\end{align*}
...
\begin{equation}\label{eq:parahelium_HF_equation}
    \hat{h}(1)\phi(1) +
    \int \frac{\phi^*(2)\phi(2)}{r_{12}} d2\ \phi(1)
     = \varepsilon\phi(1).
\end{equation}
...
\begin{equation*}
    h_{rs} = \opbracket<\chi_r(1)|\hat{h}(1)|\chi_s(1)>,
\end{equation*}
